...
public sealed partial class IrkAssistantDialog : ContentDialog
{
    ...
    private void ApplyText()
    {
        ...
        PsToolsTitleText.Text = App.State.T("IrkAssistantPsToolsTitle");
        PsToolsDescriptionText.Text = App.State.T("IrkAssistantPsToolsDescription");
        PsToolsDownloadText.Text = App.State.T("IrkAssistantDownloadPsTools");
        PsToolsUrlBox.Header = App.State.T("IrkAssistantPsToolsUrlLabel");
        WindowsExportTitleText.Text = App.State.T("IrkAssistantWindowsExportTitle");
        WindowsExportDescriptionText.Text = App.State.T("IrkAssistantWindowsExportDescription");
        ...
        WindowsImportTitleText.Text = App.State.T("IrkAssistantWindowsImportTitle");
        WindowsImportDescriptionText.Text = App.State.T("IrkAssistantWindowsImportDescription");
        ...
        MacGuideDescriptionText.Text = App.State.T("IrkAssistantMacDescription");
